...
def sum_gd(k, time_s, many, norm, bench):
    ...
    if many=="3":
        print("lolooo")
        with open(bench + "_" + k + "_" + time_s + "_" + "1" + ".txt", 'r') as myfile:
            data = myfile.read().replace('\n', '')
    elif time_s=="rvp":
        with open(bench + "_" + k + "_" + "alltime" + "_" + "1" + ".txt", 'r') as myfile:
            data = myfile.read().replace('\n', '')
    else:
        with open(bench + "_" + k + "_" + time_s + "_" + str(many) + ".txt", 'r') as myfile:
            data = myfile.read().replace('\n', '')
...
def chart_gd(k, time_s, many, norm, bench):
    ...
    if time_s=="rvp":
        ...
        ras_3 = pd.read_csv(bench +"_" + k + "_" + "three_years" + "_" + str(many) + ".csv").head(10)

        ras_5 = pd.read_csv(bench +"_" + k + "_" + "five_years_ago" + "_" + str(many) + ".csv")
        ...
        ras = pd.read_csv(bench + "_" + k + "_" + time_s + "_" + str(many) + ".csv").head(10)
