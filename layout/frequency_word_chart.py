...
def four_figs(code):
    ...
    b_g = pd.read_csv(path_in_pickle +second + "_" + first + ".csv")

    g_b_p = pd.read_csv(path_in_pickle +first + "_" + second + "_pro.csv")

    b_g_p = pd.read_csv(path_in_pickle +second + "_" + first + "_pro.csv")
